...
{
    /// <summary>
    /// A base class to create enumeration classes.
    /// </summary>
    ...
    public abstract class Enumeration<T> : IEquatable<Enumeration<T>> where T : Enumeration<T>
    {
        ...
        /// </summary>
        /// <value>
        /// A <see cref="String"/> that is the value held by the <see cref="Enumeration{T}"/>.
        /// </value>
        ...
        /// <returns>
        /// <c>true</c> if the specified value is hold by any declared instance of <see cref="T"/>; <c>false</c> otherwise.
        /// </returns>
