...
public class StringToEnumerationDynamicMapperTests
{
    [Fact]
    public void MapToEnumerationDynamic_ShouldSucceed()
    {
        ...
        // Act
        var result = StringToEnumerationDynamicMapper<TestEnumerationDynamic>.MapToEnumerationDynamic(sourceString);
