...
internal partial class EnumerationDynamicModelMapper
{
    public partial EnumerationDynamicDestinationModel SourceToDestination(EnumerationDynamicSourceModel sourceModel);
}